void money() {
  ...
  text("８", 113, 435);//８の表示
  text("９", 183, 435);//９の表示
  text("10", 250, 435);//１０の表示
  text("11", 323, 435);//１１の表示
  text("12", 390, 435);//１２の表示
  text("13", 40, 495);//１３の表示
  text("14", 110, 495);//１４の表示
  text("15", 180, 495);//１５の表示
  text("16", 250, 495);//１６の表示
  text("17", 320, 495);//１７の表示
  text("18", 390, 495);//１８の表示
  text("19", 40, 555);//１９の表示
  text("20", 110, 555);//２０の表示
  text("21", 180, 555);//２１の表示
  text("22", 250, 555);//２２の表示
  text("23", 320, 555);//２３の表示
  text("24", 390, 555);//２４の表示
  text("25", 40, 615);//２５の表示
  text("26", 110, 615);//２６の表示
  text("27", 180, 615);//２７の表示
  text("28", 250, 615);//２８の表示
  text("29", 320, 615);//２９の表示
  text("30", 390, 615);//３０の表示
