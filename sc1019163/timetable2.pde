void timetable2() {
  ...
  //月曜日の前半の時間割
  textSize(12);//フォントサイズ
  text(ns[1], 125, 185);//線形代数学の表示(1*1)
  textSize(11);//フォントサイズ
  text(ns[2], 123, 250);//数学総合演習の表示(1*2)

  //火曜日の前半の時間割
  textSize(20);//フォントサイズ
  text(ns[0], 195, 187);//線形代数学の表示(2*1)
  textSize(11);//フォントサイズ
  text(ns[4], 192, 250);//情報機器概論の表示(2*2)
  textSize(20);//フォントサイズ
  text(ns[3], 195, 320);//コミュの表示(2*2)

  //水曜日の前半の時間割
  textSize(13);//フォントサイズ
  text(ns[5], 270, 180);//科学技術の表示(3*1)
  text(ns[6], 262, 195);//リテラシーの表示(3*1)

  //木曜日の前半の時間割
  textSize(20);//フォントサイズ
  text(ns[3], 335, 385);//コミュの表示(4*4)

  //金曜日の前半の時間割
  textSize(12);//フォントサイズ
  text(ns[7], 402, 185);//情報表現入門の表示(5*1)
  text(ns[7], 402, 250);//情報表現入門の表示(5*2)
  text(ns[7], 402, 315);//情報表現入門の表示(5*3)
