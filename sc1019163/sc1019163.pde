...
void setup() {
  ...
  kani=loadImage("img/kani.png");
  kaba=loadImage("img/kaba.png");
  inu=loadImage("img/inu.png");
  turtle=loadImage("img/turtle.png");
  tyou=loadImage("img/tyou.png");
  tanuki=loadImage("img/tanuki.png");
  kitune=loadImage("img/kitune.png");
  hati=loadImage("img/hati.png");
  panda=loadImage("img/panda.png");
  dolphin=loadImage("img/dolphin.png");
  karasu=loadImage("img/karasu.png");
  tora=loadImage("img/tora.png");
  koara=loadImage("img/koara.png");
  usagi=loadImage("img/usagi.png");
  lion=loadImage("img/lion.png");
  pengin=loadImage("img/pengin.png");
  kuzira=loadImage("img/kuzira.png");
  kamereon=loadImage("img/kamereon.png");
  wani=loadImage("img/wani.png");
  kuma=loadImage("img/kuma.png");
  taka=loadImage("img/taka.png");
  syati=loadImage("img/syati.png");
  same=loadImage("img/same.png");
  obake=loadImage("img/obake.png");
  doragon=loadImage("img/doragon.png");
  thiranosaurusu=loadImage("img/thiranosaurusu.png");
  graph=loadImage("img/graph.png");
  memo=loadImage("img/memo.png");
  karennda=loadImage("img/karennda.png");
  zikanwari=loadImage("img/zikanwari.png");
  timer=loadImage("img/timer.png");
  ikusei=loadImage("img/ikusei.png");
  nihon=loadImage("img/nihon.png");
  ...
  moneymoney=minim.loadFile("music/moneymoney.mp3");
